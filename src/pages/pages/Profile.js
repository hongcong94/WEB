...
import { Badge, Button, Card, CardBody, CardHeader, CardTitle, Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Media, Row, UncontrolledDropdown } from "reactstrap";
  ...
  return (
    <Card>
      ...
      <CardBody className="text-center">
        <img src={userInfo.avatarUrl ? `http://127.0.0.1:8887/${userInfo.avatarUrl}` : avatar1} alt={userInfo.firstName + " " + userInfo.lastName} className="img-fluid rounded-circle mb-2" width="128" height="128" />
        <CardTitle tag="h5" className="mb-0">
      ...
      <CardBody>
        ...
        <ul className="list-unstyled mb-0">
          <li className="mb-1">
            <Home width={14} height={14} className="mr-1" /> Lives in <Link to="/dashboard/default">San Francisco, SA</Link>
          </li>
      ...
      <Media>
        ...
        <Media body>
          ...
          <div className="border text-sm text-muted p-2 mt-1">
            Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt
        ...
        <Media body>
          ...
          <Media className="mt-1">
            ...
            <Media body className="pl-3">
              <div className="border text-sm text-muted p-2 mt-1">Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus.</div>
            </Media>
          </Media>
        </Media>
      </Media>
