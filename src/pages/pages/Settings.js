...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Form, FormGroup, Input, Label, ListGroup, ListGroupItem, Row, UncontrolledDropdown } from "reactstrap";
...
const PublicInfo = () => {
  ...
  const showSucessNotification = (title, message) => {
    ...
    toastr.sucsess(title, message, option);
  };
          ...
          <Row>
            <Col md="8">
              ...
              <FormGroup>
                ...
                <Input type="textarea" rows="2" id="inputBio" placeholder="Tell something about yourself" />
              </FormGroup>
            </Col>
            <Col md="4">
              <div className="text-center">
                <img alt="Chris Wood" src={previewAvatarUrl ? previewAvatarUrl : userInfo.avatarUrl ? `http://127.0.0.1:8887/${userInfo.avatarUrl}` : avatar1} className="rounded-circle img-responsive mt-2" width="128" height="128" />
